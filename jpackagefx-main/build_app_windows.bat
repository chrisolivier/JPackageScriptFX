...
xcopy /S /Q target\libs\javafx* target\installer\input\libs\
echo xcopy done
...
copy target\libs\tinylog* target\installer\input\libs\
copy target\libs\jmetro.jar target\installer\input\libs\
